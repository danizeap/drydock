...
5. Run `python3 scripts/sdd.py archive <name>` (on Windows: `python`; it independently re-checks tasks and placeholders; `--force` only with the Owner's explicit approval).
