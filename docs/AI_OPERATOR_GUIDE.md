...
VERSION: Drydock 0.7.0 | Scanner: launchguardian 0.2.0 (PyPI)
...
| 11 commands | plugin `commands/` (namespace `/drydock:`) | Lifecycle procedures, the Owner brief (`/drydock:brief`), and read-only two-agent review (`/drydock:codex-review`) |
