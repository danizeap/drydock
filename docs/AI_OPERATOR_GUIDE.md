...
VERSION: Drydock 0.11.1 | Scanner: launchguardian 0.2.0 (PyPI)
...
| 12 commands | plugin `commands/` (namespace `/drydock:`) | Lifecycle procedures, the Owner brief (`/drydock:brief`), read-only two-agent review (`/drydock:codex-review`), and the leadership-transfer relay (`/drydock:handoff`) |
