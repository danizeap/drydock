...
First living spec for the secrets-path PreToolUse guard (`hooks/protect_secrets.py`). The hook blocks agent writes to secret-bearing paths; exit 2 blocks, exit 0 allows.
