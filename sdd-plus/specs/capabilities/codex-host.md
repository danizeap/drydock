...
The Codex-native Drydock host: one plugin install plus explicit per-repository initialization, evidence-based readiness, lifecycle skills, and honest adapter and enforcement boundaries.
